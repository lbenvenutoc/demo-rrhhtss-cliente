			...
			<div class="row">
				...
				<div class="col-xs-12">
					<form class="form-horizontal">
						<table>
							<tr>
								<td><label for="form-field-1"> Apellido Paterno </label>
							...
							<tr>
								...
								<td><label for="form-field-1"> Apellido Materno </label>
							...
							<tr>
								<td><label for="form-field-1"> Nombres </label>

									<div class="col-sm-15">
										<input type="text" id="form-field-1" placeholder="Nombres"
											class="col-xs-10 col-sm-5" />
									</div></td>

							</tr>
							<tr>
								<td><div class="col-xs-12 col-sm-6">
										<div class="form-group">
											<label for="form-field-select-1">Sexo</label> <select
							...
							<tr>
								<td><label for="id-date-picker-1">Fecha de
										Nacimiento</label>
									<div class="row">
							...
							<tr>
								<td><label for="id-date-picker-1">Fecha de Estado
										Civil</label>
							...
							<tr>
								<td><label for="form-field-1"> Apellido de Casada </label>
							...
							<tr>
								<td><label for="id-date-picker-1">Feha de
										Fallecimiento</label>
							...
							<tr>
								<td><label for="id-date-picker-1">Fecha de Ingreso
										al país</label>
							...
							<tr>
								<td>
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											<label for="form-field-select-1">Modelo de Documento</label>
							...
							<tr>
								<td><label for="form-field-1"> Nro. de Documento </label>
